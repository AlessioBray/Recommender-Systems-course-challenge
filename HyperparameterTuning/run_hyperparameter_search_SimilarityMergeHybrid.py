...
from Recommenders.Hybrid.SimilarityMergeHybrid import SimilarityMergeHybridRecommender
...
""
def runHyperparameterSearch_SimilarityMergeHybridRecommender(recommenders, URM_train, ICM_object, ICM_name, URM_train_last_test = None,
   ...
   ##########################################################################################################
    ...
    try:
        ...
        hyperparameterSearch = SearchBayesianSkopt(SimilarityMergeHybridRecommender, evaluator_validation=evaluator_validation, evaluator_test=evaluator_test)
