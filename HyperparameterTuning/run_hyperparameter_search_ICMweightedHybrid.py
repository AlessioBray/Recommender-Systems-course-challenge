...
from Recommenders.Hybrid.ICMweightedHybrid import SLIMElasticNetICMweightedHybrid
...
""
def runHyperparameterSearch_SLIMElasticNetICMweightedHybrid(recommender, recommender_params, URM_train, ICM_object, ICM_name, URM_train_last_test = None,
   ...
   ##########################################################################################################
    ...
    try:
        ...
        hyperparameterSearch = SearchBayesianSkopt(SLIMElasticNetICMweightedHybrid, evaluator_validation=evaluator_validation, evaluator_test=evaluator_test)
        ...
        hyperparameters_range_dictionary["delta"] = Real(low = 0.001, high = 0.999, prior = 'uniform')

        recommender_input_args = SearchInputRecommenderArgs(
            CONSTRUCTOR_POSITIONAL_ARGS = [URM_train, ICM_object, recommender_params],
