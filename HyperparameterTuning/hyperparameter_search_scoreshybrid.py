...
def runHyperparameterSearch_ScoresHybrid(recommender_class, URM_train, ICM_object, ICM_name, URM_train_last_test = None,
    ...
    :param recommender_class:   List of classes of the recommender object to optimize, it must be a BaseRecommender type
   ...
   ##########################################################################################################
    ...
    try:
        ...
        output_file_name_root = recommender_class[0].RECOMMENDER_NAME + "_" + recommender_class[1].RECOMMENDER_NAME
        ...
        if recommender_class in [ScoresHybridRecommender]:

            hyperparameters_range_dictionary = {}

            hyperparameters_range_dictionary["alpha"] = Real(low = 1e-2, high = 1e2, prior = 'uniform')
